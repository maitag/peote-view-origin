...
ApplicationMain.create = function() {
	...
	ApplicationMain.app = new samples_Picking();
...
var samples_Picking = function() {
	samples_Sample.call(this);
};
samples_Picking.__name__ = true;
samples_Picking.__super__ = samples_Sample;
samples_Picking.prototype = $extend(samples_Sample.prototype,{
	run: function() {
		this.startTime = haxe_Timer.stamp();
		var t = haxe_Timer.stamp() - this.startTime;
		this.peoteView = new de_peote_view_PeoteView({ maxDisplaylists : 1, maxPrograms : 1, maxTextures : 1, maxImages : 1});
		this.peoteView.setTexture({ texture : 0, w : 512, h : 512});
		this.peoteView.imageCache.setImage({ image : 0, texture : 0, filename : "assets/peote_tiles.png"});
		this.peoteView.setProgram({ program : 0, texture : 0});
		this.peoteView.setDisplaylist({ displaylist : 0, type : 153, maxElements : 1000, maxPrograms : 1, bufferSegments : 10, x : 0, y : 0, w : 512, h : 512, z : 0, renderBackground : true, r : 0.1, g : 0.5, b : 0.8, a : 0.8, enable : true});
		this.peoteView.setElementDefaults({ displaylist : 0, image : 0, w : 100, h : 100});
		this.peoteView.setElement({ element : 0, x : 0, y : 0, rgba : -65281, pivotX : 50, pivotY : 50, rotation : 360, end : { x : 400, rotation : 180, time : haxe_Timer.stamp() - this.startTime + 20, rgba : 16777215}, program : 0, image : 0, tile : 1});
		this.peoteView.setElement({ element : 1, x : 100, y : 100, pivotX : 50, pivotY : 50, rotation : -90, program : 0, image : 0, tile : 2});
		this.peoteView.setElement({ element : 2, x : 150, y : 100, pivotX : 50, pivotY : 50, rotation : 135, program : 0, image : 0, tile : 3});
	}
	,onMouseDown: function(window,x,y,button) {
