...
ApplicationMain.create = function() {
	...
	ApplicationMain.app = new samples_GlyphTextRendering();
...
var samples_GlyphTextRendering = function() {
	this.element_nr = 0;
	samples_Sample.call(this);
};
samples_GlyphTextRendering.__name__ = true;
samples_GlyphTextRendering.__super__ = samples_Sample;
samples_GlyphTextRendering.prototype = $extend(samples_Sample.prototype,{
	run: function() {
		var _g = this;
		...
		this.peoteView.setTexture({ texture : 0, w : 600, h : 591});
		this.peoteView.imageCache.setImage({ image : 0, texture : 0, filename : "assets/DejavuSans.png", preload : true});
	...
	,__class__: samples_GlyphTextRendering
});
